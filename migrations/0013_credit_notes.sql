...
ALTER TABLE invoice_payments ADD COLUMN IF NOT EXISTS kind text NOT NULL DEFAULT 'payment';
ALTER TABLE invoice_payments DROP CONSTRAINT IF EXISTS invoice_payments_kind_check;
ALTER TABLE invoice_payments ADD CONSTRAINT invoice_payments_kind_check CHECK (kind IN ('payment', 'credit'));
...
ALTER TABLE invoice_payments ADD COLUMN IF NOT EXISTS reason text;
