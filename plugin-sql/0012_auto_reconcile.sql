...
ALTER TABLE __NS__.company_settings ADD COLUMN IF NOT EXISTS auto_reconcile boolean NOT NULL DEFAULT true;
ALTER TABLE __NS__.company_settings ADD COLUMN IF NOT EXISTS auto_reconcile_threshold integer NOT NULL DEFAULT 90;
